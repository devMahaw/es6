...
var marcelo = new Aluno("Marcelo", 8.0);
var joao = new Aluno("João", 3.0);
var maria = new Aluno("Maria", 5.0);
var beatriz = new Aluno("Beatriz", 10.0);
var alunos = [marcelo, joao, maria, beatriz];
